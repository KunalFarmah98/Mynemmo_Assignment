...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginview = findViewById(R.id.loggin_in);
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // to hide the keypad on pressing login
    ...
    private void attemptLogin() {
        ...
        if(!TextUtils.isEmpty(email) && TextUtils.isEmpty(password)){
            ...
            error.setText("Please Enter Your Credentials");
            error.setVisibility(View.VISIBLE);
            focusView = mEmailView;
            cancel=true;
        }
    ...
    private boolean isEmailValid(String email) {
        return email.equals("Tom");
    }

    private boolean isPasswordValid(String password) {
        return password.equals("1234abc");
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                Thread.sleep(2000);
                startActivity(new Intent(LoginActivity.this , second_screen.class));
            } catch (InterruptedException e) {
                return false;
            }

            for (String credential : DUMMY_CREDENTIALS) {
                return credential.equals(mEmail);
            }
